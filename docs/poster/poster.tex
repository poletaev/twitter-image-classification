 ...
 \begin{document}
     ...
     \begin{columns}
       ...
       \block{Overview}{
         ...
         The first version was build on Microsoft Azure platform and heavily utilises it's tools such as: Queue Service, Blob storage service, Table service, SQL Azure Database, Bing Maps API. Parts of the system were launched on three trial accounts provided by Microsoft for school participants.
